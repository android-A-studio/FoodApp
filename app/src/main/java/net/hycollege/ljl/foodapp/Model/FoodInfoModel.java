...
import net.hycollege.ljl.foodapp.greendao.db.DaoMaster;
import net.hycollege.ljl.foodapp.greendao.db.DaoSession;
import net.hycollege.ljl.foodapp.greendao.db.FoodBeanDao;
